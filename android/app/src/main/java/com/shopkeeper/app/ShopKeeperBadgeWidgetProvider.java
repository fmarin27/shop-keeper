...
public class ShopKeeperBadgeWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateAllWidgets(Context context, int count) {
        ...
        ComponentName widget = new ComponentName(context, ShopKeeperBadgeWidgetProvider.class);
    ...
    private static void updateWidget(
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.shop_keeper_badge_widget);
